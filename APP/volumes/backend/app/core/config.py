...
class Settings:
    def __init__(self) -> None:
        ...
        self.hub_notification_ttl_seconds = _read_int("HUB_NOTIFICATION_TTL_SECONDS", default=900)
        self.hub_notification_history_limit = _read_int("HUB_NOTIFICATION_HISTORY_LIMIT", default=100)
        self.hub_sse_heartbeat_seconds = _read_int("HUB_SSE_HEARTBEAT_SECONDS", default=15)
        self.hub_sse_retry_ms = _read_int("HUB_SSE_RETRY_MS", default=2000)
