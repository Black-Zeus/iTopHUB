...
PROFILE_MODULE_OPTIONS = [
    ...
    {"moduleCode": "reassignment", "label": "Actas de Reasignacion"},
...
PANEL_DEFAULTS: dict[str, dict[str, Any]] = {
    ...
    "docs": {
        ...
        "handoverDocumentLegendEnabled": True,
        "handoverDocumentLegendText": "Documento emitido desde iTop HUB",
        "showFooter": True,
...
def normalize_panel_config(panel_code: str, config: dict[str, Any]) -> dict[str, Any]:
    ...
    if panel_code == "docs":
        ...
        return {
            ...
            "handoverDocumentLegendEnabled": _coerce_bool(
                merged.get("handoverDocumentLegendEnabled"),
                PANEL_DEFAULTS["docs"]["handoverDocumentLegendEnabled"],
            ),
            "handoverDocumentLegendText": _coerce_str(
                merged.get("handoverDocumentLegendText"),
                PANEL_DEFAULTS["docs"]["handoverDocumentLegendText"],
            ),
