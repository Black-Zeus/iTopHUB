  ...
  return (
    <div className={`relative flex min-h-[72px] items-start gap-3 ${collapsed ? "justify-center" : ""}`}>
      <div
        ...
        aria-hidden="true"
      >
        <div className={`relative z-[1] mt-[0.1rem] grid place-items-center rounded-[18px] border border-white/20 bg-[radial-gradient(circle_at_top_left,rgba(255,255,255,0.38),transparent_44%),linear-gradient(180deg,#b5dbf4_0%,#7bb4d9_100%)] font-extrabold text-white shadow-[0_10px_24px_rgba(58,121,164,0.26)] before:pointer-events-none before:absolute before:left-1/2 before:top-1/2 before:z-[-1] before:h-16 before:w-16 before:-translate-x-1/2 before:-translate-y-1/2 before:rotate-[8deg] before:rounded-[21px] before:border before:border-[rgba(120,182,217,0.2)] before:content-[''] ${collapsed ? "h-[50px] w-[50px]" : "h-[48px] w-[48px] text-[1.3rem]"}`}>
          IH
        </div>
        <div
