...
const STATUS_MAP = {
  ...
  "en-laboratorio": { label: "En laboratorio", cls: "bg-[var(--accent-soft)] text-[var(--accent-strong)]" },
  pendiente: { label: "Pendiente", cls: "bg-[rgba(224,181,107,0.14)] text-[var(--warning)]" },
  "pendiente-de-firma": { label: "Pendiente de firma", cls: "bg-[rgba(81,152,194,0.16)] text-[var(--accent-strong)]" },
  ...
  completada: { label: "Completada", cls: "bg-[rgba(127,191,156,0.14)] text-[var(--success)]" },
  ...
  "derivada-a-obsoleto": { label: "Derivada a obsoleto", cls: "bg-[rgba(210,138,138,0.14)] text-[var(--danger)]" },
