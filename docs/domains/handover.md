...
- `Actas de Normalizacion` are intentionally exposed only as a menu entry and mockup page for now; no operational workflow, emit, or confirmation path should be assumed active until that phase is implemented.
